...
class LibrosController extends Controller
{
    ...
    {
        $es_sections = SectionLanguage::getAllLibro();
        return view('admin.libros.index', compact('es_sections'));
    }
    ...
    {
        $sections = SectionLanguage::editLibro($request, $this->path_image);
        if ($sections) {
