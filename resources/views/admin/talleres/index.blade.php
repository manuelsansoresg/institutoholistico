                                ...
                                @foreach ($es_sections as $es_section)
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                {{ Form::open(['route' => ['talleres.destroy', $es_section['id']], 'class' => 'form-inline', 'method' => 'DELETE']) }}
                                                <a href="/#talleres" target="_blank" class="btn btn-success btn-block"><i
                                                        class="far fa-eye"></i> </a>

                                                <a href="{{ route('talleres.edit', $es_section['lang']) }}"
