        ...
        <div class="row">
            <div class="col-12 bg-white">
                <div class="box py-3 px-3">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        {{ Form::open(['route' => ['talleres.update', $section_id], 'method' => 'PUT', 'files' => true]) }}
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    @if ($image != '')
                                        <img src="{{ asset('img/talleres') . '/' . 'thumb_' . $image->image }}" alt="">
                                        <div class="pull-right">
                                            <p>
                                                <br>
                                                <a href="/admin/talleres/image/destroy/{{ $image->id }}/{{ $set_lang }}"
