        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="/admin/cabecera">Cabecera</a></li>
        ...
        <div class="row">
            <div class="col-12 bg-white">
                <div class="box py-3 px-3">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        {{ Form::open(['route' => ['cabecera.update', $section_id], 'method' => 'PUT', 'files' => true]) }}
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">
                                            Imagen dimensiones recomendadas (382 pixeles ancho * 482 pixeles alto)
                                        </label>
                                ...
                                <div class="col-md-2">
                                    @if ($image != '')
                                        <img src="{{ asset('img/cabecera') . '/' . 'thumb_' . $image->image }}" alt="">
                                        <div class="pull-right">
                                            <p>
                                                <br>
                                                <a href="/admin/cabecera/image/destroy/{{ $image->id }}/{{ $set_lang }}"
