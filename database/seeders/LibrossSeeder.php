...
class LibrossSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $section_language = new SectionLanguage();
        $section_language->section_id = 6;
        $section_language->name = 'titlelibro1';
        $section_language->lang = 'es';
        $section_language->description = 'a) Anatomía y fisiología del aura: campos, chakras, interfase, esferas mentales y conexiones: ';
        $section_language->save();

        $section_language = new SectionLanguage();
        $section_language->section_id = 6;
        $section_language->name = 'description1';
        $section_language->lang = 'es';
        ...
        $section_language = new SectionLanguage();
        $section_language->section_id = 6;
        $section_language->name = 'titlelibro2';
        $section_language->lang = 'es';
        $section_language->description = 'b)Mi energía,,, mi salud. La respuesta para la sanación de las enfermedades:   ';
        $section_language->save();
        ...
        $section_language->name = 'titlelibro1';
        $section_language->lang = 'en';
        $section_language->description = 'a) Anatomy and physiology of the aura: fields, chakras, interphase, mental spheres and  connections: ';
        $section_language->save();
        ...
        $section_language->name = 'titlelibro2';
        $section_language->lang = 'en';
        $section_language->description = '  b) My energy ,,, my health. The answer for the healing of diseases:';
        $section_language->save();
        ...
        $section_language->name = 'titlelibro1';
        $section_language->lang = 'fr';
        $section_language->description = "a) Anatomie et physiologie de l'aura: champs, chakras, interphases, sphères mentales et connexions: ";
        $section_language->save();
        ...
        $section_language->name = 'titlelibro2';
        $section_language->lang = 'fr';
        $section_language->description = ' b) Mon énergie ,,, ma santé. La réponse pour la guérison des maladies: ';
        $section_language->save();
